...
const uint16_t U16_ADC_THRE2_WALL_LIST[SENSOR_DIR::SENS_NUM] = {2800, 3000, 3000, 3000, 3000, 3000, 3000, 3000};
const uint16_t U16_ADC_THRE2_FLOR_LIST[SENSOR_DIR::SENS_NUM] = {900, 900, 900, 900, 900, 900, 900, 900};
//const uint16_t U16_ADC_THRE2_WALL_LIST[SENSOR_DIR::SENS_NUM] = {10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000};
//const uint16_t U16_ADC_THRE2_FLOR_LIST[SENSOR_DIR::SENS_NUM] = {0, 0, 0, 0, 0, 0, 0, 0};
...
void main(void *params) {
  ...
  while(1) {
    ...
    #if 1
    // Filter値
    DEBUG_PRINT_FDT("[FDT]%4d,%4d,%4d,%4d,%4d,%4d,%4d,%4d\n",
                    U16_ADC_BUF_AVE[0],
                    U16_ADC_BUF_AVE[1],
                    U16_ADC_BUF_AVE[2],
                    U16_ADC_BUF_AVE[3],
